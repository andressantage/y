...
$autor = $username; // Reemplaza con el nombre del autor que deseas filtrar
...
$datos = json_decode($resultados, true);

// Filtrar los resultados por autor
$resultados_filtrados = array_filter($datos, function ($item) use ($autor) {
    return strtolower($item['autor']) == strtolower($autor);
});
...
foreach ($resultados_filtrados as $resultado) {
    $link = $resultado['link'];
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">            
            ...
            <div class="navbar-nav ml-auto d-flex align-items-center justify-content-center">
                <ul class="navbar-nav">            
                    <li class="nav-item d-flex align-items-center">
                        <a class="nav-link text-white lead"> <?php echo $username ?></a>
                        <a class="nav-link ml-auto pl-0" href="salir.php"><button type="button" class="btn btn-secondary m-1">Cerrar sesión</button></a>
                    </li>
                    <li class="nav-item d-flex align-items-center">
...
.then((data) => {
    console.log(data) //imprime el resultado de la peticion en formato json
})
.catch((error) => {
...
[
  {
    "titulo": "johnathan",
    "autor": "Mr. Johnathan Boyle",
    "link": "https://cloudflare-ipfs.com/ipfs/Qmd3W5DuhgHirLHGVixi6V76LhCkZUz6pnFt5AJBiyvHye/avatar/687.jpg",
    "descripcion": "Estoy comiendo",
    "id": "1"
  },
  {
  "titulo": "correr",
  "autor": "Giovany",
  "link": "uploads/correr_correr.jpg",
  "descripcion": "Persona corriendo",
  "id": "2"
  }
]</code></pre>
                </div>
            ...
            <div class="modal-body">
                <form method="POST" action="validar.php">
                    ...
                    <div class="d-flex justify-content-lg-start align-item-center mt-2">
                        <a href="" class="m" data-toggle="modal" data-target="#exampleModal1">¿Has olvidado tú contraseña?</a>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
<!-- muestra imagenes -->
<div id="api" class="contenedor row d-flex justify-content-center align-item-center">
...
<script>
//pone las imagenes para mostrar
